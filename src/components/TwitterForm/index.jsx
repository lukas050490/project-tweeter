    ...
    return (
        <div className="border-b border-gray-800 p-4">
            ...
            <div className="flex justify-between items-center mt-4">
                ...
                <buttom className="bg-blue-400 text-white font-bold px-4 py-2 rounded-full hover:bg-blue-600 transition duration-200 cursor-pointer"
                    onClick={handleSubmit}>Tweet</buttom>
            </div>
        </div>
